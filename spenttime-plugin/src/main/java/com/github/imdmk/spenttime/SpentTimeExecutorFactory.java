...
/**
 * Factory and utilities for worker executor used by SpentTime.
 */
final class SpentTimeExecutorFactory {

    private static final String WORKER_THREAD_NAME = "SpentTime-Worker";
    private static final Duration SHUTDOWN_TIMEOUT = Duration.ofSeconds(3);

    private SpentTimeExecutorFactory() {
        throw new UnsupportedOperationException("This is a utility class and cannot be instantiated.");
    }

    /**
     * Creates a dedicated single-threaded worker executor for asynchronous plugin operations.
     * The executor uses a named daemon thread ({@code SpentTime-Worker}).
     *
