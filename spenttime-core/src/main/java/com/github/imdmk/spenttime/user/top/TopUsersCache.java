...
public interface TopUsersCache {
     ...
     */
    CompletableFuture<List<User>> getTopBySpentTime();
     ...
     * @return future containing an ordered list of top users
     */
    CompletableFuture<List<User>> getTopBySpentTime(int limit);

    /**
     * Invalidates all cached leaderboard data.
     * Next invocation of {@link #getTopBySpentTime()} will trigger a reload.
     */
    void invalidateAll();
}
