...
final class SpentTime {
    ...
    private BukkitListenerRegistrar bukkitListenerRegistrar;
    ...
    void enable(@NotNull final List<Class<? extends PluginModule>> enabledModules) {
        ...
        this.bukkitListenerRegistrar = new BukkitListenerRegistrar(this.plugin);
    ...
    private void bindCore(@NotNull Resources resources) {
        ...
        resources.on(BukkitListenerRegistrar.class).assignInstance(this.bukkitListenerRegistrar);
