package com.github.imdmk.playtime.core.platform.litecommands.argument;

import com.github.imdmk.playtime.core.injector.annotations.lite.LiteArgument;
import com.github.imdmk.playtime.core.platform.identity.IdentityCache;
import com.github.imdmk.playtime.core.shared.message.MessageConfig;
...
class UUIDArgumentResolver extends ArgumentResolver<CommandSender, UUID> {
    ...
    @Inject
    UUIDArgumentResolver(IdentityCache cache, MessageConfig messageConfig) {
        this.cache = cache;
