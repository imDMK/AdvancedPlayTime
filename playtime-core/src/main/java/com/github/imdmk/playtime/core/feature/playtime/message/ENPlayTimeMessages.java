...
public final class ENPlayTimeMessages
    ...
    @Comment({
            ...
            "#",
            "# Placeholders:",
            "#   {PLAYER_NAME}  - name of the player whose playtime was updated.",
    ...
    Notice playTimeTopCacheInvalidated = Notice.chat(
            "<dark_gray>• <gray>Playtime top cache has been invalidated.<dark_gray>"
    );
